...
class InfiniteScroll extends React.Component {
  ...
  render() {
    let reversion = false;
    if (
      this.props.direction === DIRECTION_RIGHT ||
      this.props.direction === DIRECTION_DOWN
    ) {
      reversion = true;
    }
    ...
    return (
      ...
      >
        {reversion ? <div className="clone">{this.props.children}</div> : ""}
        <div
          className="infinite-scroll-items"
          ref={(el) => {
            this.scrollItem = el;
          }}
        >
